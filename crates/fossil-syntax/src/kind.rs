...
impl SyntaxKind {
    ...
    fn from_raw_value(v: u16) -> Self {
        match v {
            ...
            49 => Self::PREFIX_DECL,
            50 => Self::SOURCE_DEF,
            51 => Self::MULTI_SOURCE_DEF,
            52 => Self::TYPE_DEF,
            53 => Self::MAPPING,
            54 => Self::MAPPING_HEADER,
            55 => Self::MAPPING_BODY,
            56 => Self::PROPERTY,
            57 => Self::PROPERTY_LHS,
            58 => Self::IMPORT,
            59 => Self::IMPORT_PATH,
            60 => Self::SELECTIVE_IMPORT,
            61 => Self::ALIAS,
            62 => Self::SHAPE_EXPR,
            63 => Self::IN_CLAUSE,
            64 => Self::ANNOTATION_BLOCK,
            65 => Self::ANNOTATION_ITEM,
            66 => Self::EXPR,
            67 => Self::TEMPLATE_EXPR,
            68 => Self::INTERP_STRING_EXPR,
            69 => Self::INTERPOLATION,
            70 => Self::IRI_EXPR,
            71 => Self::LITERAL_EXPR,
            72 => Self::FIELD_REF_EXPR,
            73 => Self::PIPELINE_EXPR,
            74 => Self::TERNARY_EXPR,
            75 => Self::BINARY_EXPR,
            76 => Self::UNARY_EXPR,
            77 => Self::POSTFIX_EXPR,
            78 => Self::PAREN_EXPR,
            79 => Self::RECORD_LITERAL,
            80 => Self::RECORD_FIELD,
            81 => Self::ARG_LIST,
            82 => Self::ARG,
            83 => Self::NAMED_ARG,
            84 => Self::ERROR,
