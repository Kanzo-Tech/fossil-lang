...
[Holons](/docs/design/cells) is the argument for the cell pyramid being a third artefact.
...
([holons](/docs/design/cells), [the reference viewer](/docs/design/reference-viewer)).
...
[Holons](/docs/design/cells) carries that argument and this page does not repeat it.
