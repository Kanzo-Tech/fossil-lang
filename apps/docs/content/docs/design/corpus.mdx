...
What runs lives in `apps/corpus/conformance/verify.mjs` and `containers.mjs`, and the conventions
they check are documented for reader implementors on the corpus site rather than here.
