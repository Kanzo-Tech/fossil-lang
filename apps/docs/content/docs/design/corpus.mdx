...
That is the same defect as [the name of the cell pyramid](/docs/design/holons#the-name-promises-a-nesting-this-does-not-have):
a borrowed name promising a contract the artefact does not honour. It is not a tenth divergence —
...
So the compatibility question that makes [the pyramid's name](/docs/design/holons#the-name-promises-a-nesting-this-does-not-have)
