...
streamed the CSR from disk instead of holding it is still open**, and it is now worth about 0.8 GiB
rather than the 4 GiB the argument for it was written against. That is a different, smaller decision
than it was, and it is unmeasured.
</Callout>
