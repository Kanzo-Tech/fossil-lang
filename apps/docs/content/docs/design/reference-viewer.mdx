...
[Holons](/docs/design/cells) is the page that rules on that, and the grouping it rules over is
...
23 on the same graph — [holons](/docs/design/cells) has that table. Grouping by position is worse
